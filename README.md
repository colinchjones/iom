...
├── notebooks/            # Demonstrations for each model type
├── src/
│   ├── iom.py            # IOM computation utilities
│   ├── flows.py          # Normalizing flow transforms
│   ├── shap_utils.py     # SHAP value computation wrappers
└── README.md
```
